...
public class DiagramEditor extends GraphicalEditor {
	public final static String ID = "gef.tutorial.step.ui.DiagramEditor";// 我们要加一个
		private GraphicalViewer viewr;																	// ID用于标示这个
																			// Editor

	@Override
	protected void initializeGraphicalViewer() {

		this.viewr.setContents(new HelloModel());
	...
	protected void configureGraphicalViewer() {
		...
		this.viewr=this.getGraphicalViewer();
		this.viewr.setEditPartFactory(new PartFactory());
	}
